...
{  
    ...
    DIR *dir;
    struct dirent *ent;
    const char* xyzdir = "/users/40265864/sharedscratch/MSc_ML_MM/handup/molecules/"; //Alter if required
    string base = xyzdir; 
    dir = opendir(xyzdir);
    if (dir == nullptr) {
    ...
    while((ent = readdir(dir)) != nullptr){
        string newfile = base + ent->d_name + "/" + ent->d_name + ".xyz";
        ifstream xyzfile;
    ...
    cout << "#symmetry functions: " << symfunctions.size() << endl;
    string csvfile = "evaluated_sf.csv";
